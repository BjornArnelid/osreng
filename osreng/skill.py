...
_base_skills = [BEAST_LORE, BLUFFING, SLEIGHT_OF_HAND, SPOT_HIDDEN, LANGUAGES, CRAFTING, ACROBATICS, HUNTING_AND_FISHING,
               BARTERING, HEALING, MYTHS_AND_LEGENDS, RIDING, SWIMMING, SEAMANSHIP, SNEAKING, EVADE, PERFORMANCE,
               AWARENESS, BUSHCRAFT, PERSUASION, CROSSBOWS, HAMMERS, KNIVES, BOWS, BRAWLING, SLINGS, SPEARS, STAVES,
               SWORDS, AXES]


def roll_general_skills(skills_to_ignore, number_of_picks):
    return pick_n_unique([x for x in _base_skills if x not in skills_to_ignore], number_of_picks)